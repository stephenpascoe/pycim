...
XML_FILE = 'activity.simulation_run.xml'
...
class TestDecodeSimulationRun(unittest.TestCase):
    ...
    def test_decode_obj_from_xml(self):
        ...
        assert obj.cim_info.id == uuid.UUID('5e45202c-2b2a-11e1-a1f2-00163e9152a5')
        assert obj.cim_info.version == '2'
        assert obj.cim_info.create_date == dateutil_parser.parse('2012-02-24 16:26:48.499198')
